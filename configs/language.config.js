const { CPP, C, PYTHON, JAVA, NODEJS, RUBY, PROMPTV1, PROMPTV2, GO, PHP, RUST } = require('../enums/supportedLanguages')
...
const LANGUAGES_CONFIG = {
    ...
    [PHP]: {
        compile: 'php -l solution.php', // PHP lint to check for syntax errors
